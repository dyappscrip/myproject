...
def manager_list(request):
    ...
    return render(request, 'back/manager_list.html',{'manager_list':manager_list})
...
def manager_group_del(request,word):
...
def manager_perms_del(request,word):
    ...
    perms = Permission.objects.filter(name=word)
    perms.delete()
