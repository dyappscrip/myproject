...
urlpatterns = [
    ...
    url(r'^panel/manager/group/del/(?P<word>.*)/$', views.manager_group_del, name='manager_group_del'),
    url(r'^panel/manager/perms/del/(?P<word>.*)/$', views.manager_perms_del, name='manager_perms_del'),
